...
\btab{1.1}{ l l }
	Server side: & Node.js, C\# (MVC .NET), Python (Django), PHP, and SQL (MySQL, Microsoft SQL Server). \\
	Client side (some experience): & JavaScript(Angular as well as normal JS), CSS, HTML. \\
